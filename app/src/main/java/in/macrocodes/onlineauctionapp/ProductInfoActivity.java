...
public class ProductInfoActivity extends AppCompatActivity {
    ...
    ImageView imageView;
    TextView rate,sellerbidViewname,sellercity, sellerEmail;
    ...
    public void getWinnerInfo(String productName){
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Products")
                .child(productName).child("winner");
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    Log.i("winner info : " , snapshot.getValue().toString());
                    Map<String, Object> winnerData = (HashMap<String, Object>)snapshot.getValue();
                    BiddingModal winner = new BiddingModal(winnerData.get("bid").toString(), winnerData.get("uid").toString());
                    Log.i("winner bid : " , winner.getBid());
                    Log.i("winner uid : " , winner.getUid());

                    setWinnerDetails(winner.getUid(), winner.getBid());
    ...
    private void setWinnerDetails(String uid, String bid){
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Users").child(uid);
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String winnerName = snapshot.child("name").getValue().toString();
                sold.setText("Product Sold to "+winnerName + " : at price "+ bid);
            }
    ...
    private void getSellerInfo(){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                sellerEmail.setText("Email : "+ email);
